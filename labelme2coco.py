...
if __name__ == '__main__':
    labelme_path = "D:/Data_set/2/dataset/file/"
    saved_coco_path = "D:/Data_set/2/dataset/file/"
    print('reading...')
    # 创建文件
    ...
    for file in train_path:
        ...
        try:
            ...
            cv2.imwrite("{}coco/train2017/{}".format(saved_coco_path, img_name), temp_img)
    ...
    for file in val_path:
        ...
        try:
            ...
            cv2.imwrite("{}coco/val2017/{}".format(saved_coco_path, img_name), temp_img)
        except Exception as e:
            print(e)
            print('Wrong Image:', img_name)
            continue
